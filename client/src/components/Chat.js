                ...
                <div className="border-t-2 border-gray-400 px-4 pt-4 mb-2 sm:mb-0">
                  <div className="relative flex">
                    ...
                    <div className="absolute right-0 items-center inset-y-0 sm:flex">
                      ...
                      <button type="submit" className="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none hidden sm:flex">
