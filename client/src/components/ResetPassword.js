...
const ResetPassNow = () => {
    ...
    return (
        <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <p className="mt-5 text-xs font-light text-center text-gray-400"> Know your Password ? <a href="/login" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Sign in</a></p>
            <p className="mt-2 text-xs font-light text-center text-gray-400"> Dont't Know anything ? <a href="/register" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create New Account</a></p>
        </div >
    )
}
